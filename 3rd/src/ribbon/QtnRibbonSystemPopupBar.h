...
public:
    virtual QAction* addPopupBarAction(const QString& text);
    virtual void addPopupBarAction(QAction* action, Qt::ToolButtonStyle style = Qt::ToolButtonTextOnly);

    virtual RibbonPageSystemRecentFileList* addPageRecentFile(const QString& caption);
    virtual RibbonPageSystemPopup* addPageSystemPopup(const QString& caption, QAction* defaultAction, bool splitAction);
...
public:
    ...
    virtual int recentFileHeight() const = 0;
...
public:
    ...
    int recentFileHeight() const;
    virtual QAction* getCurrentAction() const;

public Q_SLOTS:
    virtual void updateRecentFileActions(const QStringList& files);
