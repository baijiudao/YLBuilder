...
/* RibbonTab */
class QTITAN_EXPORT RibbonTab : public QWidget
{
    Q_OBJECT
protected:
...
/* RibbonTabBar */
class QTITAN_EXPORT RibbonTabBar : public QWidget
{
    Q_OBJECT
...
protected:
    ...
    QMenu* addMenu(const QIcon& icon, const QString& title, Qt::ToolButtonStyle style = Qt::ToolButtonTextOnly);
