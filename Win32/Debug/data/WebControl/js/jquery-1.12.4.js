...
$(function(){
    ...
    {
        var resize_js = document.createElement("script");
        resize_js.src = "js/ichart.1.2.js";
        resize_js.type = "text/javascript";
        resize_js.id = "ylitech_js_ichart";
        document.getElementsByTagName("head")[0].appendChild(resize_js);
    }

	// if(document.getElementById("ylitech_js_action") == null)
	// {
	// 	var resize_js = document.createElement("script");
	// 	resize_js.src = "js/action.js";
	// 	resize_js.type = "text/javascript";
	// 	resize_js.id = "ylitech_js_action";
	// 	resize_js.async = "async";
	// 	document.getElementsByTagName("head")[0].appendChild(resize_js);
	// }
    ...
    {
        var resize_js = document.createElement("script");
        resize_js.src = "js/echarts.js";
        resize_js.type = "text/javascript";
        resize_js.id = "ylitech_js_echarts";
        document.getElementsByTagName("head")[0].appendChild(resize_js);
    }
