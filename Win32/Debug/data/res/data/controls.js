...
var Button = function(){
    ...
    this.createButtonContrl = function(x,y){
        ...
        this.id = idd;
        var textdiv = $('<div id='+idd+' class= "linew testy contrl move web-font '+idd+'" DataType="0,1,2,3" btnval="0" value="btn" fontcolor="#24b692" bgcolor="#b1cbe2" mousecolor="#fafbfd" fontsize="0" font="1" sure="yes"><div id=button'+idd+' class="btn" val="rect" style="box-sizing:border-box">控制按钮</div></div>');
        textdiv.prependTo($('#content'));
        var scroltop = document.body.scrollTop;
        var scrolleft = document.body.scrollLeft;
        //控件相关样式
...
var MinorAdjustment = function(){
    ...
    this.createMinorAdjustmentContrl = function(x,y){
        ...
        this.id = idd;
        var textdiv = $('<div id='+idd+' class="contrl move" DataType="1" sure="yes">' +
    ...
    this.MinorPageFeatures = function(idd){
        ...
        /*********文字颜色**********/
        inItPropertiesPage.setColor($(".textcolor"+idd), ['color', $("noselectedpic.png"+idd), 'color', $(".minbtn"+idd)]);
        /*******背景颜色************/
...
var SwitchControl = function() {
    ...
    this.createSwitchControl = function (x, y) {$("body").width($(window).width()+document.body.scrollLeft);
        ...
        this.id = idd;
        var textdiv = $('<div id='+idd+' DataType="0" class="contrl move" openbtn="开状态" closebtn="关状态" tabbtn="提示信息"></div>');
    ...
    this.copy = function(srcId,desId){
        ...
        desIdElement.children("#SwitchImage-"+srcId).attr({"backg":switchUrl});
        desIdElement.attr("openImageUrl", srcIdElement.attr("openImageUrl"));
       	desIdElement.attr("closeImageUrl", srcIdElement.attr("closeImageUrl"));
       	$('#SwitchImage-'+desId).attr('switchStatus', $('#SwitchImage-'+srcId).attr('switchStatus'));
        desIdElement.css({
            "width": wide + "px",
            "height": hige+ "px",
            "line-height":hige+ "px"
...
var SceneControl = function(){
    ...
    this.scenePropertiesPage = function(idd){
        ...
        var sceneHtml = '<fieldset class="switch_at" id="switchwrite'+idd+'">'
                        ...
                        +'<div class="scene_0">'
                        +   '<span>场景样式选择</span>'
                        +   '<select class="scene_1" id="type'+idd+'"><option value="单窗口模式" selected>单窗口模式</option><option value="双窗口模式">双窗口模式</option></select>'
                        +'</div>'
                        +'<div class="scene_0">'
...
var CheckBox = function(){
    ...
    this.createCheckBoxControl = function(x,y){
        ...
        this.id = idd;
        var textdiv = '<div id='+idd+' class="contrl checkbox_total" DataType="0,1,2,3" checkfontstyle="left" sure="yes">'+
...
var ComboBox = function(){
    ...
    this.createComboBoxControl = function (x, y) {
        ...
        this.id = idd;
        var boxDiv = $('<div id='+idd+' class="contrl move" DataType="0,1,2,3" sendButton="yes">'
                         +'<div class="combo_box">'
...
var RadioControl = function() {
    ...
    this.createRadioControl = function(x, y) {
        ...
        this.id = idd;
        var textdiv =
            $('<div id=' + idd + ' class="contrl move radio" DataType="0,1,2,3" sure="yes">' +
...
var StraightMotion = function() {
    ...
    this.createStraightControl = function (x, y) {
        ...
        this.id = idd;
        var textdiv = $('<div id='+idd+' class="contrl move" DataType="1,2" angle="0" lineall="rt" direction="right" linevertical="level">'
    ...
    this.StraightPageFeatures = function(idd) {
        ...
        var definitionSwitchshow = function() {
            switchFileElement.bind("click",function(){
                var beforeLog = inTtCommand.log();
                webapi.addLog('before',beforeLog);
                webapi.getImagePath('images'); //调用自定义接口获取图片路径
                var afterLog = inTtCommand.log();
                webapi.addLog('after',afterLog);
            });
        };
    ...
    this.copy = function(srcId,desId){
        ...
        desIdElement.attr("linevertical",linevert);
        ...
        }).addClass(clas).attr({"direction":direction}).attr("lineall",linedirection).attr("angle",angled);
...
var Rotate = function() {
    ...
    this.createRotateControl = function (x, y) {
        ...
        this.id = idd;
        var textdiv = $('<div id='+idd+' class="contrl move" DataType="0" rotatetype="type1" rotatedirection="clockwise" rotatespeed = "middle"></div>');
    ...
    this.copy = function(srcId,desId){
        ...
        var clas = srcIdElement.attr("class");
        var switchUrl = switchElement.css("background-image");
        $("#"+desId).attr("rotatetype",rotatetype);
        ...
        desIdElement.css({
            "width": wide + "px",
            "height": hige+ "px"
        }).addClass(clas).attr("class",clas).attr("lineurl",lineurl).attr("rotatetype",rotatetype).attr("rotatespeed",direction).attr("rotatedirection",linedirection);
        // 复制变量配置信息
        inItModalFeature.configInfoCopy(srcIdElement, desIdElement);
    }
};
...
var SlideBarControl = function(){
    ...
    this.createSlideBarControl = function(x, y) {
        ...
        this.id = idd;
        var textDiv = $(
            '<div id=' + idd + ' class="contrl move slidebar" DataType="1" shape="rectangle" value="level" ruleOff="have" degreeDirection="bottom" sure="yes">' +
            ...
            '<div id='+idd+' class="contrl move" alarmcolor="#ff0000" backcolor_="#ffffff">'+
                '<div class="box'+idd+' historyEventBox">'+
                    ...
                    '<div class="history_footBox">'+
                        '<div class="footdated"><span>日期查询</span><input id="myDate_start'+idd+'" class="start dated" type="date"/><span>至</span><input id="myDate_end'+idd+'" class="end dated" type="date"/><p class="search11 search1'+idd+'"></p><p class="search22 search2'+idd+'"></p><p class="search3 search3'+idd+'"></p></div>'+
                    '</div>'+
                '</div>'+
            '</div>';
	...
	this.DialPageFeatures = function(idd){
    	...
    	$("#maxval"+idd).blur  (function() {
    		if(!$("#"+idd).attr("mixeuval")){
    			...
    			if(isNaN($("#maxval"+idd).val())||$("#maxval"+idd).val()<parseInt($('#'+idd).attr('mineuval'))||$("#maxval"+idd).val()>parseInt($('#'+idd).attr('mixeuval'))||Number($(this).val())>100||Number($(this).val())<0){
    				$("#maxval"+idd).val("");
    			}else{
    				if($("#minval"+idd).val()&&$("#maxval"+idd).val()<$("#minval"+idd).val()){
    					$("#maxval"+idd).val("");
    				}else{
		...
		$("#minval"+idd).blur  (function() {
			if(!$("#"+idd).attr("mixeuval")){
    			...
    			if(isNaN($("#minval"+idd).val())||$("#minval"+idd).val()<parseInt($('#'+idd).attr('mineuval'))||$("#minval"+idd).val()>parseInt($('#'+idd).attr('mixeuval'))||Number($(this).val())>100||Number($(this).val())<0){
    				$("#minval"+idd).val("");
    			}else{
    				if($("#maxval"+idd).val()&&$("#maxval"+idd).val()<$("#minval"+idd).val()){
    					$("#minval"+idd).val("");
    				}else{
...
var StatusControl = function() {
    ...
    this.createStatusControl = function(x, y) {
        ...
        this.id = idd;
        var textDiv = $
            ('<div id='+idd+' class="contrl move boder" DataType="0,1">' +
                ...
                '<fieldset class="status_attr">' +
                    '<legend>状态配置</legend>' +
                        '<div class="statusFather">' +
                            ...
                            '<div class="status_attrText1">状态图路径</div>' +
    ...
    this.StatusPageFeatures = function(idd) {
        ...
        switchFileTxtElement.val($('#'+idd).attr('imageUrl'));
        ...
        $('.handleAdd'+idd).mouseup(function() {
            if (name != '' && value != '' && imagePath != '') {
                ...
                $('#'+idd).attr('listBoxDom', listBoxDom);
                var listCount = parseInt($('.count'+idd).val());
                $('#'+idd).attr('listCount', listCount);
            }
            var afterLog = inTtCommand.log();
            webapi.addLog('after',afterLog);
        });
        ...
        $('.defaultSize'+idd).click(function() {
            ...
            var currentWidth = $('#'+idd).css('width');
            var currentHeight = $('#'+idd).css('height');
        ...
        this.copy = function(srcId, desId) {
            ...
            var height = srcIdElement.height();
            var srcClass = srcIdElement.attr('class');
            var statusImageElement = $('#'+srcId).children('.statusImage'+srcId);
            ...
            desIdElement.css({
                ...
                'height': height + 'px',
                'line-height': height + 'px'
            }).addClass(srcClass).attr('listBoxDom', listBoxDom).attr('listCount', listCount);
        ...
        var historyAlarmHtml =
            '<div id='+idd+' class="contrl move" headcolor="#e8ebf4" priority="全部" alarmcolor="#ff0000" dateFormatIndex="0" timeFormatIndex="0">'+
                '<div class="box'+idd+' historyEventBoxd">'+
                    ...
                    '</div>'+
                    '<div class="alarmfoot">'+
                        '<div class="footdate"><span>日期查询</span><input id="myDate_start'+idd+'" class="start dated" type="date"/><span>至</span><input id="myDate_end'+idd+'" class="end dated" type="date"/><p class="search1 search1'+idd+'"></p><p class="search2 search2'+idd+'"></p><p class="search3 search3'+idd+'"></p></div>'+
                    '</div>'+
                '</div>'+
            '</div>';
...
var Chart = function() {
    ...
    this.ChartPageFeatures = function(idd) {
        ...
        /***********栏数初始化**********/
        //$(".chartgrid"+idd).val($("#"+idd).attr("chartgrid"));
        /***********栏数设置***********/
        /*$(".chartgrid"+idd).keyup(function(){
            var beforeLog = inTtCommand.log();
            webapi.addLog('before',beforeLog);
            grid = parseInt($(this).val());
            if(grid != "" && grid >= 0){
                $("#"+idd).attr("chartgrid",grid);
                chart_type();
            }else{
                $(this).val("");
            }
...
var ElevatorControl = function() {
    ...
    this.createElevatorControl = function(x, y) {
        ...
        var textDiv = '<div id='+idd+' telvatorch="telvatorch1" valuenamett="电梯名称" class="contrl move fillContrl" DataType="1" DataType1="0" DataType2="0" DataType3="1">'
				...
				+		'<li><a><span class="elevatordown" id="elevatoronoff'+idd+'"></span></a></li>'
				+		'<li ><a id="nowfloor'+idd+'">3层</a></li>'
				+	'</ul>'
...
var VideoControl = function() {
    ...
    this.createVideoControl = function(x, y) {
        ...
        this.id = idd;
        var textdiv = $(
            '<div id=' + idd + ' class="contrl move" type="windowDisplay" directionControl="no" imageType="0" cameraName="摄像头名称/位置">' +
                '<div class="totalVideo totalVideo'+idd+'">' +
                    ...
                    '<div class="settingArea settingArea'+idd+'">' +
                        ...
                        '<div class="cloudControl cloudControl'+idd+'">' +
                            '<img class="disableControl disableControl'+idd+'" src="images/cloudControl_disabled.png" style="cursor: not-allowed"/>' +
                        '</div>' +
                        '<div class="picList picList'+idd+'">' +
                            '<img id="capturePic-'+idd+'" src="images/capturePic.png" title="抓拍">' +
                            '<img id="fullScreen-'+idd+'" src="images/fullScreen.png" title="全屏">' +
                            '<img id="exitFullScreen-'+idd+'" src="images/exitFullScreen.png" title="退出全屏">' +
                        '</div>' +
                    '</div>' +
                '</div>' +
            '</div>'
            ...
            '<div id="tc3' + idd + '" class="tc33">' +
                '<fieldset class="videoAttrs">' +
                    ...
                    '<div class="videoFather">' +
                        ...
                        '<div class="videoDiv"><i>视频窗口样式展示</i><div class="video_attrDiv" id="windowDisplay'+idd+'"></div></div>' +
                        '<div class="videoDiv"><i>视频热点样式展示</i><div class="video_attrDiv" id="hotspotDisplay'+idd+'"></div></div>' +
                        '<div class="videoDiv"><i>有云台控制功能</i><div class="video_attrDiv" id="directionControl'+idd+'"></div></div>' +
                    '</div>' +
                '</fieldset>' +
                '<fieldset class="videoAttrs">' +
                    '<legend>抓图</legend>' +
    ...
    this.VideoPageFeatures = function(idd) {
        ...
        var cloudControlElement2 = $('<img class="disableControl disableControl'+idd+'" src="images/cloudControl_disabled.png" style="cursor: not-allowed"/>');
        ...
        var windowDisplay = function() {
            if ($('#'+idd).attr('type') === 'windowDisplay') {
                if ($('#'+idd).attr('totalDom')) {
                    var temp = $('#'+idd).attr('totalDom');
                    $('#'+idd).append(temp);
                    $('#'+idd).removeAttr('totalDom');
                    $('#'+idd).css({
                        'height': '310px',
                        'width': '600px',
        ...
        var hotspotDisplay = function() {
            if ($('#'+idd).attr('type') === 'hotspotDisplay') {
                $('#'+idd).attr('totalDom', $('#'+idd).html());
        ...
        var settingFeatures = {
            ...
            setWindowDisplay: function() { //窗口样式展示
                windowDisplayElement.click(function() {
                    ...
                    var value = $('#'+idd).attr('type');
                    if (value === 'hotspotDisplay') {
                        $('#'+idd).removeAttr('type', 'hotspotDisplay');
                        $('#'+idd).attr('type', 'windowDisplay');
                        windowDisplay();
                    }
                    var afterLog = inTtCommand.log();
                    webapi.addLog('after',afterLog);
            ...
            isDisplayCloudControl: function() { //是否展示云台控制功能
                $('#directionControl'+idd).click(function() {
                    var beforeLog = inTtCommand.log();
                    webapi.addLog('before',beforeLog);
                    if ($('#'+idd).attr('directionControl') === 'yes') {
                        $('#directionControl'+idd).css({'background': 'url(images/notselected.png)'});
                        $('#'+idd).attr('directionControl', 'no');
                        $('.enableControl'+idd).remove();
                        $('.cloudControl'+idd).append(cloudControlElement2);
                    } else {
                        $('#directionControl'+idd).css({'background': 'url(images/selected.png)'});
                        $('#'+idd).attr('directionControl', 'yes');
                        $('.disableControl'+idd).remove();
                        $('.cloudControl'+idd).append(cloudControlElement1);
                    }
                    var afterLog = inTtCommand.log();
                    webapi.addLog('after',afterLog);
                });
            ...
            initControl: function() { //初始化控件
                $(".config_dis"+idd).attr("disabled","true");
                if ($('#'+idd).attr('cameraBrand')) {
                    cameraBrandSelect.val($('#'+idd).attr('cameraBrand'));
                }
                if ($('#'+idd).attr('ip')) {
                    inputIPElement.val($('#'+idd).attr('ip'));
                }
                if ($('#'+idd).attr('port')) {
                    inputPortElement.val($('#'+idd).attr('port'));
                }
                if ($('#'+idd).attr('username')) {
                    inputUserNameElement.val(unCompile($('#'+idd).attr('username')));
                }
                if ($('#'+idd).attr('password')) {
                    inputPasswordElement.val(unCompile($('#'+idd).attr('password')));
                }
                if ($('#'+idd).attr('cameraName')) {
                    cameraName = $('#'+idd).attr('cameraName');
                ...
                } else if ($('#'+idd).attr('type') === 'hotspotDisplay'){
                    $('#windowDisplay'+idd).css({'background': 'url(images/weixuan.png)'});
                    $('#hotspotDisplay'+idd).css({'background': 'url(images/yixuan.png)'});
                }       
                if ($('#'+idd).attr('directionControl') === 'yes') {
                    $('#directionControl'+idd).css({'background': 'url(images/selected.png)'});
                } else if ($('#'+idd).attr('directionControl') === 'no'){
                    $('#directionControl'+idd).css({'background': 'url(images/notselected.png)'});
                }
                if ($('#'+idd).attr('imageType')) {
                    $('#captureFileFormat'+idd).val($('#'+idd).attr('imageType'));
                }
                if ($('#'+idd).attr('dirPath')) {
                    $('#videofileText'+idd).val($('#'+idd).attr('dirPath'));
                }
            },
            init: function() {
                this.setCameraBrand();
        ...
        this.copy = function(srcId, desId) {
            ...
            if (directionControl === 'yes') { //有云台控制功能
                desIdElement.attr('directionControl', 'yes');
                $('#directionControl'+desId).css({'background': 'url(images/selected.png)'});
                $('.disableControl'+desId).remove();
                $('.cloudControl'+desId).append(cloudControlElement1);
            }
            if (dirPath) {
                desIdElement.attr('dirPath', dirPath);
            }
            if (type === 'hotspotDisplay') { //热点展示
                $('.totalVideo'+desId).remove();
                desIdElement.css({
                    'width': $('#'+srcId).css('width'),
                    'height': $('#'+srcId).css('height'),
                    'background-image': 'url(images/videoHotspot.png)',
                    'background-repeat': 'no-repeat',
                    'background-size': '100% 100%',
                    'padding': '0px',
                    ...
                    'totalDom': srcIdElement.attr('totalDom'),
                    'type': 'hotspotDisplay'
                });
            }
        };
...
var CommunicateTestControl = function(){
    ...
    this.createcommunicateTestControl = function(x,y) {
        ...
        this.id = idd;
        var $div = $('<div id=' + idd + ' class="contrl move'+idd+'">' +
